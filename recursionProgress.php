...
<html>
	...
	<head>
		<title>Recursion Progress</title>
	...
	<body>
		<header><h1>Recursion Progress</h1></header>
		<?php
			require("./connect.php");
			
			$classAvgEx1 = mysql_query("SELECT AVG(mark) FROM marks WHERE `exercise name`='Recursion' && `exercise num`=1");
